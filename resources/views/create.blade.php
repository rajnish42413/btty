        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                ...
                <form method="POST" action="{{ url('/links') }}">
                    ...
                    <div class="form-group row">
                        <label for="url" class="col-md-2 col-form-label text-md-right">{{ __('Custom Hash by Value') }}</label>

                        <div class="col-md-8">
                            <input id="hash" type="text" class="form-control @error('hash') is-invalid @enderror" name="hash" value="{{ old('hash') }}" placeholder="custom hash value (Optional)" autocomplete="off" autofocus>
